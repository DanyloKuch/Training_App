...
//             .Select(e => Exercise.Create(e.Id, e.Name, e.Muscles, e.CountOfBasicSets, e.CreatedByUserId, e.Weight).Exercise)
//             .ToList();
//
//         return exercises;
//     }
...
//             CreatedByUserId = exercise.CountOfWurmUpSets,
...
//                 .SetProperty(ex => ex.CreatedByUserId, countOfWurmUpSets)
...
//             exerciseEntity.CreatedByUserId,
